...
class MA_BertConfig(PretrainedConfig):
    r"""
    ...
    def __init__(
        ...
        predicition_head_hidden_act="gelu",
        ...
        output_hidden_states = True, # For Knowledge Transfer
        output_attentions = True, # For Knowledge Transfer
        verbose = False,
        **kwargs
    ):
        ...
        self.predicition_head_hidden_act = predicition_head_hidden_act
        ...
        self.ffn_hidden_act = ffn_hidden_act
        ...
        self.share_softmax_nn=share_softmax_nn ### For sharing 2-layer neural network approximation across encoder layer 
        ...
        if verbose:
            ...
            print(f"Encoder Activation Function: {self.ffn_hidden_act}")
